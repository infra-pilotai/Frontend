...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Privacy Policy for Infra-PilotAI.com — how we collect, use, and protect your personal data." },
...
const h2 = "font-display text-2xl tracking-wider text-foreground";
const h3 = "font-display text-lg tracking-wider text-foreground";
const h4 = "font-display text-base tracking-wider text-foreground";
        ...
        <article className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc space-y-3 pl-6">
              ...
              <li><strong className="text-foreground">Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to {COMPANY_NAME}, operating {SITE_DOMAIN}.</li>
              ...
              <li><strong className="text-foreground">Country</strong> refers to: {SITE_COUNTRY}</li>
              ...
              <li>
                ...
                <a href={SITE_URL} rel="external nofollow noopener" target="_blank" className={link}>{SITE_URL}</a>.
              </li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li><strong className="text-foreground">With Service Providers:</strong> We may share Your Personal Data with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
              ...
              <li><strong className="text-foreground">With business partners:</strong> We may share Your Personal Data with Our business partners to offer You certain products, services or promotions.</li>
              <li><strong className="text-foreground">With other users:</strong> If Our Service offers public areas, when You share Personal Data or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</li>
          ...
          <section className="space-y-4">
            ...
            <h3 className={h3}>Usage, Performance and Miscellaneous</h3>
            <p>We may use third-party Service Providers to maintain and improve our Service.</p>
            <ul className="list-disc space-y-4 pl-6">
              <li>
                <p><strong className="text-foreground">Mouseflow</strong></p>
                ...
                <p>The information gathered by Mouseflow is held in accordance with its Privacy Policy: <a href="https://mouseflow.com/privacy/" rel="external nofollow noopener" target="_blank" className={link}>https://mouseflow.com/privacy/</a></p>
              </li>
              <li>
                <p><strong className="text-foreground">FreshDesk</strong></p>
                ...
                <p>The information gathered by FreshDesk is held in accordance with its Privacy Policy: <a href="https://www.freshworks.com/privacy/" rel="external nofollow noopener" target="_blank" className={link}>https://www.freshworks.com/privacy/</a></p>
              </li>
              <li>
                <p><strong className="text-foreground">Google Places</strong></p>
                ...
                <p>The information gathered by Google Places is held in accordance with the Privacy Policy of Google: <a href="https://www.google.com/intl/en/policies/privacy/" rel="external nofollow noopener" target="_blank" className={link}>https://www.google.com/intl/en/policies/privacy/</a></p>
              </li>
            </ul>
          </section>
