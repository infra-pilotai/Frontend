...
import { SITE_NAME, SITE_URL, COMPANY_NAME, SITE_FAVICON_URL } from "../lib/site";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Predict outages, optimize resources, and self-heal cloud systems with an AI-driven operations layer built for enterprise infrastructure teams." },
    ...
    links: [
      ...
      { rel: "icon", href: SITE_FAVICON_URL, type: "image/png" },
      { rel: "apple-touch-icon", href: SITE_FAVICON_URL },
